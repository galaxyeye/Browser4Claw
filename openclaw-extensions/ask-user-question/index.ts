 ...
 * and waits for the user's response via an HTTP callback to B4Claw.
 *
 * This enables delete-confirmation modals on the B4Claw desktop app
...
const plugin = {
  ...
  description: 'Structured user confirmation tool for B4Claw desktop.',
  configSchema: {
  ...
  register(api: OpenClawPluginApi) {
    ...
    api.registerTool((ctx) => {
      // Only enable for B4Claw desktop sessions (sessionKey starts with 'agent:main:lobsterai:').
