...
Real-time web search capability for B4Claw using Playwright-controlled browser automation.

## Overview

The Web Search Skill enables B4Claw to perform live web searches using Google and Bing, with automatic fallback when one provider is unavailable. The skill uses Playwright to control a local Chrome browser instance, making all operations transparent and observable.
...
This skill is part of the B4Claw project. For issues or suggestions:
