...
This guide walks through testing the entire Web Search Skill integration with B4Claw.

## Prerequisites

1. B4Claw built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with B4Claw.

**Steps:**

1. Start B4Claw in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of B4Claw launch.
...
1. Open a terminal while B4Claw is running
...
**Objective:** Verify graceful shutdown of services when B4Claw quits.

**Steps:**

1. With B4Claw running and searches completed, quit the application
...
1. Start B4Claw (ensure headless is false in config)
...
- ✅ Server auto-starts with B4Claw
