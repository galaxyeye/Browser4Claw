...
# "Calendar access permission is required. Please open System Settings > Privacy & Security > Calendar, and authorize Terminal or B4Claw"
```
...
```
**Solution:** Open System Settings > Privacy & Security > Calendar, authorize Terminal or B4Claw
