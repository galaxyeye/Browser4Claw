 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/B4Claw/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\B4Claw\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/B4Claw/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`B4Claw started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
